      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="usage_progress" mb="4" isInvalid={!!formik.errors?.usage_progress}>
              <FormLabel>Usage Progress</FormLabel>
              <NumberInput
                name="usage_progress"
                value={formik.values?.usage_progress}
                onChange={(valueString, valueNumber) =>
                  formik.setFieldValue('usage_progress', Number.isNaN(valueNumber) ? 0 : valueNumber)
                }
              >
                <NumberInputField />
                <NumberInputStepper>
              ...
              {formik.errors.usage_progress && <FormErrorMessage>{formik.errors?.usage_progress}</FormErrorMessage>}
            </FormControl>
